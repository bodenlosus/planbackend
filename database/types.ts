...
export type Database = {
	...
	depots: {
		Tables: {
			...
			savings_plans: {
				Row: {
					...
					created: string
					depot_id: number
					frequency: Database["public"]["Enums"]["savingsfrequency"]
					id: number
					last_changed: string
		...
		Views: {
			...
			savings_plans_with_asset: {
				Row: {
					...
					depot_id: number | null
					description: string | null
					frequency: Database["public"]["Enums"]["savingsfrequency"] | null
					id: number | null
		...
		Functions: {
			...
			delete_savings_plan: { Args: { p_id: number }; Returns: undefined }
			...
			update_savings_plan: {
				Args: {
					p_asset_id: number
					p_frequency: Database["public"]["Enums"]["savingsfrequency"]
					p_id: number
					p_worth: number
				}
				Returns: undefined
